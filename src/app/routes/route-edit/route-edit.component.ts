...
export class RouteEditComponent implements OnInit {
  ...
  /*----------  route stops methods  ----------*/
  onAddStop() {
    const form = this.newStopsForm.controls;
    ...
    this.newStopsForm.reset();
    this.isCollapsed = true;
  }

  onSaveStop(stopId: number) {
    const pos = this.route.stops.findIndex(s => s.stopId === stopId);
    this.route.stops[pos].stopTime = this.editStopsForm.controls['stopTime'].value;
    this.route.stops[pos].location = this.editStopsForm.controls['stopLocation'].value;
    this.route.stops[pos].stopTime = this.editStopsForm.controls['stopTime'].value;
